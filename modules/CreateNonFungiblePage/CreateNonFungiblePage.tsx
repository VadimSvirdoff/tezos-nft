...
import {
  ...
  incrementStep,
  steps
} from 'rtk/slices/createNft';
import { mintTokenAction } from 'rtk/async/actions';
import { validateCreateNftStep } from 'rtk/validators/createNft';
        ...
        >
          ...
          <Flex flex="1" justify="flex-end">
            ...
            <FormModal
              ...
              afterClose={() => router.replace('/collections')}
              dispatchOnOpen={true}
              pendingAsyncMessage={
                <>
                  Opening wallet...
